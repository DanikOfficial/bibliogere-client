...
const ValidarQuestoesModal: React.FC<ValidarQuestoesModalProps> = ({ close, GoToUpdate }) => {
    ...
    const onConfirm = () => {
        ...
        // Clear errors
        setError(defaultValidarQuestoesErrorResponse);
            ...
            <div className="modal-container-custom">
                <div className="modal-content-custom">
                    ...
                    <div className="modal-header-custom">
                        ...
                        <h2 className="modal-title">Validar Questões de Segurança</h2>
                        <p className="modal-subtitle">Confirme a sua identidade para prosseguir</p>
                    </div>
                    ...
                    <div className="info-banner">
                        ...
                        <span>Responda as questões de segurança que configurou durante o registo</span>
                    </div>
                    ...
                    <div className="modal-form">
                        ...
                        <div className="form-section">
                            ...
                            <div className="question-card">
                                <strong>{questoes.primeiraQuestao}</strong>
                            </div>
                        ...
                        <div className="form-section">
                            ...
                            <div className="question-card">
                                <strong>{questoes.segundaQuestao}</strong>
                            </div>
                    ...
                    <div className="modal-footer-hint">
                        ...
                        <span>Suas respostas são verificadas de forma segura</span>
                    </div>
                </div>
            </div>
